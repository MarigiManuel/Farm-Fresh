...
<head>
    <meta charset="utf-8">
    <title>FarmFresh - Home Page</title>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="home_ui/img/favicon.ico">
...
<body>
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">FarmFresh</a>. All Rights
                Reserved. Designed by <a class="text-secondary fw-bold" href="https://etech.com">Manuel</a></p>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script src="{{ asset('home_ui/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('home_ui/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('home_ui/lib/counterup/counterup.min.js') }}"></script>
    <script src="{{ asset('home_ui/lib/owlcarousel/owl.carousel.min.js') }}"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('home_ui/js/main.js') }}"></script>
</body>
